...
class RepairValidator:
    ...
    def _setup_net_filter(self, whitelist_ips: list = None) -> bool:
        ...
        cmd = ['sudo', 'bash', str(NET_FILTER_SETUP_SCRIPT), container_name]
        if whitelist_ips:
            cmd.append(','.join(whitelist_ips))
    ...
    def _validate(self, skip_normal: bool, skip_malicious: bool) -> dict:
        ...
        if skip_normal:
            ...
            try:
                result['normal_ok'] = self.validate_module.validate_normal_request()
            except Exception as e:
        ...
        if skip_malicious:
            ...
            try:
                result['malicious_blocked'] = self.validate_module.validate_malicious_request()
            except Exception as e:
