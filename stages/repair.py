...
class RepairGenerator:
    ...
    def __init__(self, cve: CVEConfig, repair_mode: str = "filter", whitelist_mode: str = "static"):
        self.cve = cve
    ...
    def run(
        ...
        for json_file in json_files:
            ...
            self._process_file(json_file, threshold, backtrack_repair, filter_irrelevant)
    ...
    def _process_file(
        ...
        candidates = self._filter_candidates(pairs, threshold)
    ...
    def _filter_candidates(self, pairs: list, threshold: float) -> list:
